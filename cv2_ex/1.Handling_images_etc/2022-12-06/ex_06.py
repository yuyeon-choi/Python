...
# cv2.imshow("dst_tmep1", dst_tmep1)  # 한글 깨짐..
# cv2.imshow("dst_tmep2", dst_tmep2)
# cv2.waitKey(0)


img90 = cv2.rotate(image, cv2.ROTATE_90_CLOCKWISE)  # 시계방향으로 90도 (반시계 : cv2.ROTATE_90_COUNTERCLOCKWISE)
img180 = cv2.rotate(image, cv2.ROTATE_180)  # 180도 회전
img270 = cv2.rotate(image, cv2.ROTATE_90_COUNTERCLOCKWISE)  # 시계방향 270도 회전 = 반시계 90도 회전
