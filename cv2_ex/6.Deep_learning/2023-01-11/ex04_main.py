...
def main():    
    ...
    train_aug = A.Compose([
        ...
        A.OneOf([
            ...
            A.RandomSunFlare(flare_roi= (0, 0, 0.05, 0.001),            # 수치 많이 낮춤 올리면 너무 이미지가 안보임
    ...
    # test.py = Aug.py를 같이 먹여야한다. 
    # train Aug는 마음대로 해도된다.
    ...
    # visualize_augmentation(train_dataset)   #aug 확인
    # exit()
    ...
    # print(model1) # classifier[3] 모델 확인하고 [] 사용에 맞는 index 입력
    ...
    for index, model in enumerate(model_list):
        ...
        # csv 만들려서 pandas 사용해서 datafrmae 만든거다.
        ...
        for epoch in range(epochs) :
            ...
            model.train()
            train_bar = tqdm(train_loader, file=sys.stdout, colour='green')   # tqdm = 훈련 수치 실시간으로 알려주는 시각화함수이다.
