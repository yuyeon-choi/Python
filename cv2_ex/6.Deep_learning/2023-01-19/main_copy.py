...
# val 만 써도 되지만 헷갈리면 test val train 만들어두고 쓰기!
...
'''
https://cvml.tistory.com/24 핀메모리와 넘워크에 대한 설명 참조
'''
# dataloader------------------------------------------------------------------------
...
model = torch.hub.load('facebookresearch/deit:main',
                       'deit_tiny_patch16_224', pretrained=True) # test에는 False로
