...
def image_download(keywords):
    create_folder("./cv2_ex/2.Data_Augmented_etc/2022-12-12/" + keywords + "_high_resolution")
    ...
    for k, i in enumerate(links):
        try:
            ...
            urllib.request.urlretrieve(
                url, "./cv2_ex/2.Data_Augmented_etc/2022-12-12/"+keywords+"_high_resolution/"+keywords+"_"+str(k-forbidden)+".jpg")
