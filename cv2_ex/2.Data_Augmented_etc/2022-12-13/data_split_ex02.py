...
cat_image_path = "./cv2_ex/2.Data_Augmented_etc/2022-12-13/image/cats/"
dog_image_path = "./cv2_ex/2.Data_Augmented_etc/2022-12-13/image/dogs/"
...
if flog == True:
    for dog_train_path in dog_train_data:
        ...
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/train/dog/", exist_ok=True)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/train/dog/{dog_train_file_name}", dog_train_img)
    ...
    for dog_val_path, dog_test_path in zip(dog_val, dog_test):
        ...
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/val/dog/", exist_ok=True)
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/test/dog/", exist_ok=True)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/val/dog/{dog_val_name}", dog_val_img)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/test/dog/{dog_test_name}", dog_test_img)
...
if flog == True:
    for cat_train_data_path in cat_train_data:
        ...
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/train/cat/", exist_ok=True)
        file_name = os.path.basename(cat_train_data_path)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/train/cat/{file_name}", img)
    ...
    for cat_val_path, cat_test_path in zip(cat_val, cat_test):
        ...
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/val/cat/", exist_ok=True)
        os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/test/cat/", exist_ok=True)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/val/cat/{file_name_val}", img_val)
        cv2.imwrite(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/dataset/test/cat/{file_name_test}", img_test)
