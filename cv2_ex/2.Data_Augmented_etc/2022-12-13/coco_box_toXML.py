...
for i, image_info in enumerate(coco_info['images']):
    ...
    os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/xml_folder/", exist_ok=True)  # exist_ok=True: 폴더가 이미 있으면 넘어가라
    xml_save_path = "./cv2_ex/2.Data_Augmented_etc/2022-12-13/xml_folder/test.xml"
