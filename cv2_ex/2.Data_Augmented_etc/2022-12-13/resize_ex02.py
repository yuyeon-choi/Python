...
img_path_list = image_file("./cv2_ex/2.Data_Augmented_etc/2022-12-13/image01_T/images/")
...
for img_path in img_path_list:
    ...
    os.makedirs("./cv2_ex/2.Data_Augmented_etc/2022-12-13/image01_T/resize", exist_ok=True)
    img_new.save(f"./cv2_ex/2.Data_Augmented_etc/2022-12-13/image01_T/resize/{image_name}.png", quality=100)
